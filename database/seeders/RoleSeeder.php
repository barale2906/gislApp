...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create([
            'name'=>'hu_plantas',
            'descripcion'=>'Ver listado de personal de planta',
            'modulo'=>'humana'
        ])->syncRoles([$Superusuario,$Financiero,$Administrativo]);

        Permission::create([
            'name'=>'hu_plantasModify',
            'descripcion'=>'Modificar personal de planta',
            'modulo'=>'humana'
        ])->syncRoles([$Superusuario,$Financiero,$Administrativo]);

        Permission::create([
            'name'=>'hu_nominas',
            'descripcion'=>'Ver listado de nómina',
            'modulo'=>'humana'
        ])->syncRoles([$Superusuario,$Financiero,$Administrativo]);

        Permission::create([
            'name'=>'hu_nominasModify',
            'descripcion'=>'Modificar nómina',
            'modulo'=>'humana'
        ])->syncRoles([$Superusuario,$Financiero,$Administrativo]);
