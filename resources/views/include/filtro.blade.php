    ...
    @if ($is_filtro)
        @if ($is_creacion)
            <div class="mb-6 ring-1 ring-zinc-600 rounded-md p-2">
                <label for="filtroCreades" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Fecha de entrega programada</label>
        ...
        @if ($is_banco)
            <div class="mb-6 ring-1 ring-zinc-600 rounded-md p-2">
                <label for="banco_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Banco</label>
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <label for="banco_id" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Elegir Banco</label>
                </div>
            </div>
        @endif
    @endif
