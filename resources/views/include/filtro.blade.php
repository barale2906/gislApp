<div class="grid sm:grid-cols-1 md:grid-cols-6 gap-4 m-2">
    ...
    @if ($is_filtro)
        ...
        @if ($is_inicia)
            <div class="mb-6 ring-1 ring-zinc-600 rounded-md p-2">
                <label for="filtroIniciades" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Fecha de inicio</label>
                <div class="relative z-0 w-full mb-5 group">
        ...
        @if ($is_termina)
            <div class="mb-6 ring-1 ring-zinc-600 rounded-md p-2">
                <label for="filtroTerminades" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Fecha de finalización</label>
                <div class="relative z-0 w-full mb-5 group">
