            ...
            <div class="relative z-0 w-full mb-5 group">
                <div class="flex">
                    <div class="flex items-center me-4">
                        <input type="radio" value="1" name="clase" wire:model="clase" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="inline-radio" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Por Evento</label>
                    </div>
                    <div class="flex items-center me-4">
                        <input type="radio" value="2" name="clase" wire:model="clase" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="inline-2-radio" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Global</label>
                    </div>
                </div>
            </div>
