<div>
    ...
    @endif
    @if ($is_creating)
        <livewire:configuracion.usuarios.user-modificar :elegido="$elegido" :tipo="$tipo"/>
    @endif

    @if ($is_perfil)
        <livewire:configuracion.usuarios.user-perfil :elegido="$elegido"/>
    @endif
