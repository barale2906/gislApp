<div>
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3" style="cursor: pointer;" wire:click="organizar('mes')">
                            MES
                            @if ($ordena != 'mes')
                                <i class="fas fa-sort"></i>
                            @else
                        ...
                        <th scope="col" class="px-6 py-3" style="cursor: pointer;" wire:click="organizar('calculo')">
                            CALCULO
                            @if ($ordena != 'calculo')
                                <i class="fas fa-sort"></i>
                            @else
    ...
    @endif
    @if ($is_creating)
        <livewire:humana.devengado.devengados-create :elegido="$elegido" :tipo="$tipo"/>
    @endif
